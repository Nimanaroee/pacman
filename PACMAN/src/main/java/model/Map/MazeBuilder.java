...
public class MazeBuilder {
    ...
    public MazeBuilder(int aDimension) {
        // Initialize
        this(aDimension, 2*aDimension);
    }
    // constructor
    public MazeBuilder(int xDimension, int yDimension) {
    ...
    public static void main(String[] args) {
        model.Map.MazeBuilder maze = new model.Map.MazeBuilder(2);
        maze.draw();
        for(int i=0 ; i<5 ; i++) {
            for(int j=0 ; j<5 ; j++)
                System.out.println(maze.grid[i][j]);
        }
        System.out.println(maze.getGridX());
        System.out.println(maze.getGridY());
    }
}
